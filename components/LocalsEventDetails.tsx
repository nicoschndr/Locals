...
const LocalsEventDetails: React.FC<LocalsEventDetailsProps> = ({ event, onBackPress }) => {
    ...
    return (
        <ScrollView style={{ height: '100%' }}>
            <Image source={{ uri: event?.imageUrl || PLACEHOLDER }} style={{ width: '100%', height: 400 }} />
            <Ionicons
                name="chevron-down"
                size={24}
                color="white"
            ...
            <View style={{ padding: 20 }}>
                <View style={styles.titleContainer}>
                    ...
                    <Image
                        source={{ uri: user?.imageUrl || PLACEHOLDER }}
